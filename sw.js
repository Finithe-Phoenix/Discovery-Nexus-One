...
const ASSETS = ['./', './index.html', './enterprise.css?v=3.0.0', './premium.css?v=4.0.0', './demo-store.js?v=5.0.0', './enterprise.js?v=5.0.0', './experience.css?v=5.0.0', './experience.js?v=5.0.0', './decision.css?v=6.0.0', './decision-model.js?v=6.0.0', './decision.js?v=6.0.0', './manifest.webmanifest', './nexus-icon.svg', './icon-192.png', './icon-512.png'];
